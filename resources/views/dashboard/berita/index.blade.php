        ...
        <div class="card-body">
          ...
          <table id="example2" class="table table-bordered table-hover">
            ...
            <tr>
              ...
              <td>
                <a href="/dashboard/berita/{{ $berita->id }}" class="btn btn-info"><i class="far fa-eye nav-icon"></i></a>
                <a href="/dashboard/berita/{{ $berita->id }}/edit" class="btn btn-warning"><i class="far fa-edit nav-icon"></i></a>
